...
def sample_events():
  List = []
  List.append(Event(101, "Midterm", "2025-10-08", "09:00", "Duane"))
  List.append(Event(102, "Seminar", "2025-10-09", "09:00", "ECCR"))
  List.append(Event(103, "Hackathon", "2025-10-07", "14:00", "UMC"))
  List.append(Event(104, "Workshop", "2025-10-05", "10:00", "CASE"))
  return List

def test_merge_sort_linked_list(sample_events, build_linked_list,extract_tuples):
  ll = build_linked_list(sample_events)
  ll.head = quickSort(ll.head)
  sorted_events = extract_tuples(ll.head)
  expected = sorted((e.date,e.time) for e in sample_events)
  assert sorted_events == expected, "❌ Quick Sort failed to sort linked list of events"
